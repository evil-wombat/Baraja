...
#Esta función nos ayuda a entender como intercambiar valores dentro de una lista
'''
...
#Definimos una función que pueda intercambiar posiciones en cualquier lista.
